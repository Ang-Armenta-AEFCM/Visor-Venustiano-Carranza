...
function saveState() {
  if (!initialized) return;
  localStorage.setItem('visorStateV3:Visor_Venustiano_Carranza', JSON.stringify({
...
function restoreState() {
  let state = {};
  try { state = JSON.parse(localStorage.getItem('visorStateV3:Visor_Venustiano_Carranza') || '{}'); } catch {}
